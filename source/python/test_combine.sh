...
anaconda3-launch python $script_path/source/python/replacejulia.py ${array[0]} 0 $endfl $nx $ny $outputdir
...
#$1 is the AR name, $2 the cut off, $3 is the smoothing parameter, $4 the down sampling, $5 the number of files and $6 the number of readings (10 in this version)

#base="/media/dmac/TOSHIBA_EXT/new_wind_test/output"
