...
# start_time = "2022-02-21 06:00"
# end_time = "2022-02-25 00:00"


# X=goes_xray(start_time, end_time,SatelliteNumber = 17)      # select the time limits and goes satellite number

# picked_time_, fluxA, fluxb = X.get_data()                   #  get the data

# X.plot_xray(picked_time_, fluxA, fluxb)                     # plot_xray( time , fluxA , fluxb )  
